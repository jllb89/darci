...
const BREADCRUMB_RULES: BreadcrumbRule[] = [
  ...
  { kind: "prefix", path: "/admin/notifications", breadcrumb: { section: "Admin", current: "Notifications" } },
  { kind: "prefix", path: "/admin/billing", breadcrumb: { section: "Admin", current: "Billing operations" } },
  ...
  { kind: "prefix", path: "/app/admin/notifications", breadcrumb: { section: "Admin", current: "Notifications" } },
  { kind: "prefix", path: "/app/admin/billing", breadcrumb: { section: "Admin", current: "Billing operations" } },
  ...
  { kind: "prefix", path: "/app/billing", breadcrumb: { current: "Billing" } },
  {
    kind: "prefix",
    path: "/app/documents/",
