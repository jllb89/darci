...
| Membership terms | Review the exact renewal/cancellation/refund/tax disclosures; approved prices and product defaults are not being reopened. | [Current pricing decision](member-pricing-v2-review-proposal-2026-09-23.md): 3/$9.99, 25/$19.99, Unlimited/$59.99 monthly; $99/$199/$599 annual. [Consolidated billing draft v0.1](member-billing-review-draft-2026-09-23.md). | Product defaults approved; exact customer terms, tax and refund/dispute policy pending. |
